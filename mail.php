<?php
    ...
    */
    ...
    $destinataire = 'gragor46@gmail.com';
    ...
    */
    ...
    else
    {
    	...
    	if (($nom != '') && ($prenom != '') && ($email != '') && ($message != ''))
    	{
    		...
    		{
				var_dump($email_destinataire);
    			if (mail($email_destinataire, $email, $message, $headers))
    				$num_emails++;
    		}
    	...
    	else
    	{
    		...
    		echo '<p>'.$message_formulaire_invalide.' <a href="index.php#contact">Retour au formulaire</a></p>'."\n";
    	};
